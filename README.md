...
| [MCMC.rs](MCMC.rs/README.md) | Statistical MCMC — RW/slice/Gibbs/composed kernels, static HMC, adaptive unit/diagonal/dense metrics, differentiable constrained transforms, replica exchange, traces and multi-chain diagnostics |
