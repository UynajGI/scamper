...
| CMC.rs | Classical Monte Carlo — transactional trial evaluation, CSR lattice with physical edges, Ising/Potts/O(N), Metropolis/Wolff/SW/Heat-bath/Microcanonical, multi-spin coding, PT, JSON snapshot v2 |
