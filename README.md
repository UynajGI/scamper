...
| [MCMC.rs](MCMC.rs/README.md) | Statistical MCMC — Euclidean-state kernels (RW-Metropolis, component-wise, slice, Gibbs, composed), dense covariance adaptation, constrained transforms, replica exchange, posterior traces, multi-chain diagnostics |
