//! Variational quantum Monte Carlo for continuum systems (L0).
//!
...
//! and versioned JSON checkpoints (`qmc-rs-vmc-v1`).
//!
...
//! (L2), determinants/backflow (L1), DMC (L3) and NQS (L5) plug in later
//! behind the same [`WaveFunction`] trait without touching this layer.
...
pub use wavefunction::{
    DeltaLog, GaussianTrap, GradBuffer, HarmonicJastrow, McMillanJastrow, ParamGradBuffer, Point,
    Positions, Product, WaveFunction, WaveFunctionParams, DIM,
};
