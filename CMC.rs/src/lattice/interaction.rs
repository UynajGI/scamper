...
//! once.  Physical bonds come from [`crate::lattice::graph::CsrLattice::edges`], so
//! weighted and parallel interactions are counted without hidden `/ 2` rules.

use crate::core::cache::BatchEnergyWorkspace;
use crate::core::r#move::{BatchSpinMove, Spin};
